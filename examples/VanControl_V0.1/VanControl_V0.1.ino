...
//
// Include:
//    - DO NOT INCLUDE Communication with Nextion GUI using serial comunication (to be used with JackVan_V5.hmi)
...
int tolH=20; //tolerance (in mm) for the desired height
